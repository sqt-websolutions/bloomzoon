...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('buyer_assets/css/custom-bs4-3.css')}}">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.10.0-11/css/all.min.css">
    <link href="https://cdnjs.cloudflare.com/ajax/libs/flag-icon-css/3.1.0/css/flag-icon.min.css" rel="stylesheet">
    <link rel="stylesheet" href="/css/font-awesome.min.css">
    <link rel="stylesheet" href="{{asset('buyer_assets/css/ui.css')}}">
    <link rel="stylesheet" href="{{asset('buyer_assets/css/style.css')}}">
    <link rel="stylesheet" href="{{asset('buyer_assets/css/responsive.css')}}">
    ...
    <section class="header-top" style="background-color: #fff !important; box-shadow: 2px 2px 4px #f2f2f2;">
        <div class="container pr-0 pl-5 mr-4 ml-4" style="max-width: 95% !important; width: 100%;">
            <div class="row align-items-center">
                <div class="col-md-2">
                    <a href="/" class="">
                        <img class="logo" src="{{asset('buyer_assets/img/bloomzon.png')}}" width="120" height="auto" alt="logo">
                    </a>
                    <!-- brand-wrap.// -->
                </div>
                ...
                <div class="col-md-3 d-flex order-3">
                    <div class="top-view" style="border-right: none !important;">
                        <h5 style="color: #02499B;"><b>{{$user_metas->User[0]->id}}</b></h5>
                        <h5 style="color: #02499B;"><b>{{$user_metas->User[0]->created_at}}</b></h5>
                        <h5 style="color: #02499B;"><b>{{$user_metas->User[0]->billing_address}}</b></h5>
                    </div>
                </div>
                <!-- col.// -->
                <div class="col-md-4 order-2 order-lg-3">
                    <div class="widgets-wrap d-flex justify-content-end">
                        ...
                        <div class="widget-header ml-3 text-center">
                            <a href="#">
                                <img src="{{asset($user_metas->User[0]->profile_pic_url)}}" class="img img-circle m-auto" width="100" height="100">
        ...
        <div class="col-md-2 pb-5">
            <div class="card p-0">
                <div class="sidenav p-0">
                    ...
                    <a href="bloomzon-products?bproducts={{base64_encode('bloomzon_products')}}"><i class="fas fa-shopping-cart"></i> Bloomzon Products</a>
                    ...
                    <a href="contact-admin"><i class="fa fa-envelope"></i> Contact Admin</a>
...
<script src="{{asset('buyer_assets/js/js.js')}}"></script>
