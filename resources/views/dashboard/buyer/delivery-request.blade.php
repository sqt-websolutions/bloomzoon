...
<body style="background-color: #f2f2f2;">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="col-md-12 mb-2" style="background-color: white !important; padding: 20px;">
                    <div class="col-md-3">
                        <div class="col-md-4">
                            <img src="asset/img/shoe.png" class="img" width="60">
                            <img src="asset/img/baggy.png" class="img" width="60">
                        </div>
                        <div class="col-md-4">
                            <img src="asset/img/logitech.png" class="img" width="80">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <p><span style="font-weight: bolder">SELLERS:</span>Ose</p>
                        <p><span style="font-weight: bolder">BUYER:</span>Chuks</p>
                        <p><span style="font-weight: bolder">BILLING ADDRESS:</span></p>
                        <p><span style="font-weight: bolder">STATE:</span></p>
                    </div>
                    <div class="col-md-6" style="margin: 0 auto !important;">
                        <button type="button" class="btn btn-info mt-5 mr-5">Assign</button>
                        <button type="button" class="btn btn-danger mt-5 ml-5">View Details</button>
                        <button style="margin-left: 135px; margin-top: -10px;" type="button" class="btn btn-success pull-right">New</button>
                    </div>
                </div>
                <div class="col-md-12 mb-2" style="background-color: white !important; padding: 20px;">
                    <div class="col-md-3">
