        ...
        <div class="col-md-10">
            ...
            @if(count($products = $user_metas->Product))
                ...
                <div class="row col-md-6 mr-2">
                    <div style="background-color: white !important; padding: 20px; box-shadow: 0 4px 8px 0 rgba(0,0,0,0.1); border-radius: 0px !important; border: 1px solid #f2f2f2;">
                        <div class="col-md-4 m-auto">
                            <img src="{{asset($product->featured_img_url)}}" height="120" width="170" style="border-radius: 50%">
                        </div>
