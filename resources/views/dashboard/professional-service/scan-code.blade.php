        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="row col-md-12 text-center" style="background-color: #AF2E1D !important; padding: 10px; text-align: center !important; color:white">
                    <h1 class="text-center m-auto pt-3 pb-3"><b>Print Barcode</b></h1>
                </div>
                <div class="row mb-3" style="background-color: #fff !important; padding: 20px;">
                    <div class="col-md-6  p-5 offset-3">
                        <div style="padding: 80px; margin: 0px auto;">
                            <img src="../../../../public/prof_asset/img/scan_code.jpg" alt="">
                        </div>
                        <div class="text-center">
                            <a href="#" class="btn btn-danger btn-lg" style="margin: 0px auto;">Print</a>
                        </div>
                    </div>
