        ...
        <div class="col-md-10 mt-4 mb-4">
                ...
                <div class="row col-md-12 p-3 " style="padding: 20px;">
                    <div class="col-md-6 p-3 ml-5" >
                        <div class="row ">
                            ...
                            <div class="col-md-6 text-left "><img src="../../../../public/shopper/img/profil.png" class="img img-circle" width="50" height="50"> <b>Ose123</b></div>
                ...
                <div class="row col-md-12 p-3 " style="padding: 20px; margin-bottom: 600px !important;">
                    <div class="col-md-6 offset-6" >
                        <div class="row ">
                            <div class="col-md-6 text-left "><img src="../../../../public/shopper/img/profil.png" class="img img-circle" width="50" height="50"> <b>Shopper123</b></div>
                            <div class="col-md-6 text-right ">12/05/2020 11:23AM</div>
                        </div>
