...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="fast_food_asset/css/custom-bs4-3.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.10.0-11/css/all.min.css">
    <link href="https://cdnjs.cloudflare.com/ajax/libs/flag-icon-css/3.1.0/css/flag-icon.min.css" rel="stylesheet">
    <link rel="stylesheet" href="/css/font-awesome.min.css">
    <link rel="stylesheet" href="fast_food_asset/css/ui.css">
    <link rel="stylesheet" href="fast_food_asset/css/style.css">
    <link rel="stylesheet" href="fast_food_asset/css/responsive.css">
    <!-- Latest compiled and minified CSS -->
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css" integrity="sha384-BVYiiSIFeK1dGmJRAkycuHAHRg32OmUcww7on3RYdg4Va+PmSTsz/K68vbdEjh4u" crossorigin="anonymous">
    <!-- Optional theme -->
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap-theme.min.css" integrity="sha384-rHyoN1iRsVXV4nD0JutlnGaslCJuC7uwjduW9SVrLvRYooPp2bWYgmgJQIXwl/Sp" crossorigin="anonymous">
    <title>Fast Food &amp; Groceries Dashboard</title>
    ...
    <section class="header-top" style="background-color: #fff !important; box-shadow: 2px 2px 4px #f2f2f2;">
        <div class="container pr-0 pl-5 mr-4 ml-4" style="max-width: 95% !important; width: 100%;">
            <div class="row align-items-center">
                <div class="col-md-2">
                    <a href="/" class="">
                        <img class="logo" src="fast_food_asset/img/bloomzon.png" width="120" height="auto" alt="logo">
                    </a>
                    <!-- brand-wrap.// -->
                </div>
                ...
                <div class="col-md-2 d-flex order-3">
                    <div class="top-view" style="border-right: none !important;">
                        ...
                        <h5 style="color: #02499B;"><b>{{\Illuminate\Support\Carbon::parse($user_metas->User[0]->last_login)->format('Y/m/d')}}</b></h5>
                ...
                <div class="col-md-6 order-2 order-lg-3">
                    <div class="widgets-wrap d-flex justify-content-end">
                        ...
                        <div class="widget-header ml-3 text-center">
                            <a href="#">
                                <img src="{{$user_metas->User[0]->profile_pic_url}}" class="img img-circle m-auto" width="80" height="80">
        ...
        <div class="col-md-2 pb-5">
            <div class="card p-0">
                <div class="sidenav p-0">
                    ...
                    <a href="food-catalogue"><i class="fas fa-folder-open"></i> Food Catalogue</a>
                    <a href="food-menu"><i class="fas fa-utensils"></i> Food Menu</a>
                    <a href="orders"><i class="fas fa-copy"></i> Orders</a>
                    <a href="wallet"><i class="fas fa-wallet"></i> Wallet</a>
                    <a href="contact-admin"><i class="fas fa-envelope"></i> Contact Admin</a>
                    <a href="review-feedback"><i class="fas fa-comment-alt"></i> Reviews &amp; Feedback</a>
                    <a href="setting"><i class="fa fa-cogs"></i> Settings</a>
