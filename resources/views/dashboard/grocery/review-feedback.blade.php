        ...
        <div class="col-md-10">
                ...
                <div class="row col-md-12 mb-3" style="padding: 20px;">
                    ...
                    <div class="mb-2 p-4" style="border-radius: 20px; background-color: #fcfcfc; width: 100%; border: 1px solid #fcfcfc; text-shadow: #666;">
                        <a href="reply-review">
                            <div class="col-md-2">
                                <img src="../../../../public/fast_food_asset/img/profil.png" class="img img-circle" width="70" height="70">
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-6 text-right">
                                ...
                                <button class="btn btn-outline-primary mr-4" style="border: solid 1px #666;">Reply</button>
                            </div>
                        </a>
                    </div>
