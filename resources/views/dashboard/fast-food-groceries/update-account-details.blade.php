        ...
        <div class="p-0">
            ...
            <div class="row mb-3" style="padding: 20px;">
                <div class="col-md-8 p-5 offset-2">
                    <form name="VendorAccountDetailsForm">
                        ...
                        <div class="form-group mb-5">
                            ...
                            <input type="text" id="card_name" value="{{count($user_metas->PaymentMethod) ? $user_metas->PaymentMethod[0]->card_name: ''}}" name="card_name" class="form-control" placeholder="Pro seller">
                        </div>

                        <div class="form-group mb-5">
                            <label for="card_number" style="font-size: 16px;">Account Number: </label>
                            <input type="text" id="card_number" maxlength="10" value="{{count($user_metas->PaymentMethod) ? $user_metas->PaymentMethod[0]->card_number: ''}}" name="card_number" class="form-control" placeholder="xxxxxxxxxx">
                        </div>
...
@push('scripts')
    <script>
        FormHandler('VendorAccountDetailsForm', {
            requestUrl: "/api/v1/crud/paymentmethods/{{ count($user_metas->PaymentMethod) ? $user_metas->User[0]->id: ''}}",
            cb: response => {
                if(response.success){
                    return swal({
                        title: 'Success!!',
