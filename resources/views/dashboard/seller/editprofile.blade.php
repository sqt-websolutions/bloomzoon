        ...
        <div class="col-md-10">
            <div class="row" style="padding: 40px;">
                <div class="col-md-8 offset-2 text-center mt-2 mb-5">
                    <img src="{{asset($user_metas->User[0]->profile_pic_url)}}" height="140" width="140" style="border-radius: 50%">
                    <h5 class="text-center ">{{$user_metas->User[0]->name}}</h5>

                </div>

                <div class="col-md-8 offset-2">
                    <form name="sellerProfileUpdate">
...
@push('scripts')
    <script>
        FormHandler('sellerProfileUpdate', {
