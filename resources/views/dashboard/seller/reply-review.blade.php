...
@endsection
        ...
        <div class="col-md-10">
                <div class="row col-md-12 text-center" style="border-bottom: 1px solid #f2f2f2;">
                    <h1 class="text-center m-auto pt-3 pb-3 "><b>Reply Review</b></h1>
                </div>
                ...
                <div class="row col-md-12 p-3 " style="background-color: #fff !important; padding: 20px; margin-bottom: 500px; ">
